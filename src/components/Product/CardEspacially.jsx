...
const CardEspacially = () => {
  return (
    <>
      {main.map((mains) => {
        return (
          <div className="w-2/3 h-auto rounded-2xl bg-black/20 flex flex-col shadow shadow-blue-600  gap-2 justify-center items-center 
          hover:-translate-y-2 duration-300 ease-in-out">
            ...
            <div className="w-full h-full px-4 ">
              ...
              <div>
                <span className="text-gray-600/60"><strike>{mains.full}</strike></span>
                <div className="w-full h-full mb-4 flex justify-between">
                  <h2 className="text-2xl font-extrabold">{mains.less.toFixed(2)}$</h2>
                  <button
                    type="button"
